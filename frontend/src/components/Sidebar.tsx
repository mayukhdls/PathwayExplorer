...
export function Sidebar() {
  ...
  return (
    <aside className="h-full w-72 border-r border-slate-200 bg-white p-4 text-slate-900 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100">
      <h2 className="mb-3 text-lg font-semibold">Pathways</h2>
      <input
        className="mb-3 w-full rounded-md border border-slate-300 bg-slate-50 p-2 text-sm dark:border-slate-600 dark:bg-slate-800"
